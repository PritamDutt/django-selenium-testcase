...
class NavigationTestCase(SeleniumLiveTestCase):
    test_templates = [(r"^nav_1/$", "nav_1.html"), (r"^nav_1/nav_2/$", "nav_2.html")]
    ...
    def test_get_bad_page(self):
        ...
        self.should_see("The requested URL /bogus/ was not found on this server.")
    ...
    def test_missing_content_with_retry(self):
        ...
        self.assertRaises(
            NoSuchElementException, self.click_button, "not_there_dude", timeout=1
        )
